          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-[var(--muted-foreground)]">
                Turn AI findings into a productive lesson
              </p>
            </div>
          </div>
          {questions.length > 0 && (
      ...
      <div className="px-6 pb-6">
        ...
        {isAnalyzing && (
          <div className="flex flex-col items-center justify-center gap-4 py-10">
            ...
            <p className="text-sm text-[var(--muted-foreground)]">Personalising lesson questions…</p>
          </div>
        )}
          ...
          <div className="flex flex-col items-center gap-4 py-10">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-xs leading-relaxed text-[var(--muted-foreground)]">
                These are personalised based on your swing faults — not generic advice.
                They make your next lesson 10× more productive.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-[var(--accent)]/15 bg-[var(--accent)]/6 px-4 py-3">
              <p className="text-xs leading-relaxed text-[var(--muted-foreground)]">
                ...
                Most golfers walk into a lesson without knowing what to ask. These questions are
                generated from your swing data so your coach can focus on what actually needs fixing.
              </p>
            </div>
