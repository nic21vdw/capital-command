...
export async function POST(request: NextRequest) {
  ...
  switch (action) {
    ...
    case "deleteAllData": {
      data = { ...seedData, holdings: [], watchlist: [], researchNotes: [], goals: [], portfolioSnapshots: [], expenses: [], contentItems: [], creatorProfile: defaultCreatorProfile, executionGoals: [], executionCompletions: [], executionPeriods: [], executionDebt: [], savedThumbnails: [], videoProjects: [], executionSeededAt: new Date().toISOString() };
      break;
    }
    default:
