/**
 * "Signal" theme — same palette as signal-free-ai-builds, re-declared here so
 * this package stays standalone. Swap the palette here and every scene
 * updates globally.
 */
import { loadFont } from "@remotion/google-fonts/Poppins";

// Poppins: bold, geometric, slightly rounded sans — loaded once at module
// scope so every composition shares one registration.
...
export const COLOR_SECONDARY = "#FFD23F"; // warm yellow — highlights / price text ONLY
...
export const COLOR_BLACK = "#000000"; // fade-from-black start
...
// Landscape YouTube format (B-roll for the long-form news video).
export const VIDEO = {
  width: 1920,
  height: 1080,
  fps: 30
